...
namespace Svg
{
    ...
    internal class SvgElementFactory
    {
        ...
        private static void SetPropertyValue(SvgElement element, string attributeName, string attributeValue, SvgDocument document)
        {
            ...
            if (properties.Count > 0)
            {
                ...
                try
                {
                    ...
                    if (elementType == typeof(SvgImage) && attributeValue.Length > 65519)
                    {
                        setCustomAttribute(element, attributeName, attributeValue);
                    }
                    else
                    {
        ...
        private static void setCustomAttribute(SvgElement element, string attributeName, string attributeValue)
        {
            element.CustomAttributes[attributeName] = attributeValue;
        }
