...
namespace Svg
{
    ...
    public sealed class SvgPatternServer : SvgPaintServer, ISvgViewPort
    {
        ...
        public override Brush GetBrush(SvgVisualElement renderingElement, float opacity)
        {
            ...
            // Can't render if there a~re no dimensions
            ...
            using (SvgRenderer renderer = SvgRenderer.FromImage(image))
            {
                ...
                {
                    // I commented the line bellow because when the svg is converted to image, the image created is 1 px cutted and it makes the image comes with a white border on the right side and at the top.
